...
public final class BaseRobotTest {
    ...
    public void testRobotMovementBase() {
        ...
        try {
        	...
        	}// reached the right limit of the world: if the robot tries to move right it must fail
        	r1.moveRight();
        	Assert.fail();
        } 
        ...
        try {
        	...
        	}// reached the upper limit of the world: if the robot tries to move up it must fail
        	r1.moveUp();
       		Assert.fail();
        } 
        catch (PositionOutOfBoundException e) {
